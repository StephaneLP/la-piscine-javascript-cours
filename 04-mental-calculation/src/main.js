...
function createContainer(x,y){
    ...
    rectangle.graphics.beginFill("#063c77").drawRect(0, 0, 100, 50);
    rectangle.width = 100;
    rectangle.height = 50

    let textRectangle = new createjs.Text("rectangle","bold 1rem Arial","white")
...
export default function main(stage) {
    ...
    let circle1 = createCircle(100,200,50,"#f19648")
    let circle2 = createCircle(225,200,50,"#f5d259")
    let circle3 = createCircle(350,200,50,"#d84f35")
    ...
    initTabtReponses(tabReponses,sommeExacte)
...
function initTabtReponses(tab,sol){
